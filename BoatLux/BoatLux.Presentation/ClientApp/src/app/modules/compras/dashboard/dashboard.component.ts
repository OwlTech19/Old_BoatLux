...
export class DashboardComponent implements OnInit {
    ...
    constructor(
        ...
        if (!_usuario.checkPermissionControl('395', 'acessar')) {
    ...
    ngOnInit(): void {
        ...
        this._comprasService.obterDadosDashboard().subscribe(result => {

            this.grafico1 = {
                selected: result.graficoPrincipal.selected,
                ranges: result.graficoPrincipal.ranges,
                chartType: result.graficoPrincipal.chartType,
                datasets: result.graficoPrincipal.datasets,
                labels: result.graficoPrincipal.labels,
                colors: [
                    {
                        borderColor: '#42a5f5',
